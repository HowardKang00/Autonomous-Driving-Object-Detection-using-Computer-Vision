...
#include "my_package/msg/detail/inference_result__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_package::msg::InferenceResult & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_package::msg::InferenceResult & ros_message)
{
  // Member: class_name
  cdr >> ros_message.class_name;
...
{
  auto typed_message =
    static_cast<const my_package::msg::InferenceResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_package::msg::InferenceResult *>(
    untyped_ros_message);
...
{
  return &my_package::msg::typesupport_fastrtps_cpp::_InferenceResult__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_package, msg, InferenceResult)() {
  return &my_package::msg::typesupport_fastrtps_cpp::_InferenceResult__handle;
}
