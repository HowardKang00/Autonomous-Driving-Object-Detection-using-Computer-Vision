...
#include "yolov8_interface/msg/detail/inference_result__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yolov8_interface::msg::InferenceResult & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yolov8_interface::msg::InferenceResult & ros_message)
{
  // Member: class_name
  cdr >> ros_message.class_name;
...
{
  auto typed_message =
    static_cast<const yolov8_interface::msg::InferenceResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolov8_interface::msg::InferenceResult *>(
    untyped_ros_message);
...
{
  return &yolov8_interface::msg::typesupport_fastrtps_cpp::_InferenceResult__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolov8_interface, msg, InferenceResult)() {
  return &yolov8_interface::msg::typesupport_fastrtps_cpp::_InferenceResult__handle;
}
