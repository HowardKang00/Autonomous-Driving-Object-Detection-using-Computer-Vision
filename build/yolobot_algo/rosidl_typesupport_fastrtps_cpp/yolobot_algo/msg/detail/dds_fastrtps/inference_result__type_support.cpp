...
#include "yolobot_algo/msg/detail/inference_result__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const yolobot_algo::msg::InferenceResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolobot_algo::msg::InferenceResult *>(
    untyped_ros_message);
...
{
  return &yolobot_algo::msg::typesupport_fastrtps_cpp::_InferenceResult__handle;
}
