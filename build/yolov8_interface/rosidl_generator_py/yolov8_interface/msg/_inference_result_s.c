...
bool yolov8_interface__msg__inference_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yolov8_interface.msg._inference_result.InferenceResult", full_classname_dest, 54) == 0);
  }
  yolov8_interface__msg__InferenceResult * ros_message = _ros_message;
  {  // class_name
...
PyObject * yolov8_interface__msg__inference_result__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yolov8_interface.msg._inference_result");
