...
my_package__msg__InferenceResult__init(my_package__msg__InferenceResult * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->class_name)) {
    my_package__msg__InferenceResult__fini(msg);
    return false;
  }
  // top
  // left
...
my_package__msg__InferenceResult__create()
{
  ...
  my_package__msg__InferenceResult * msg = (my_package__msg__InferenceResult *)allocator.allocate(sizeof(my_package__msg__InferenceResult), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_package__msg__InferenceResult));
  bool success = my_package__msg__InferenceResult__init(msg);
  if (!success) {
...
my_package__msg__InferenceResult__Sequence__init(my_package__msg__InferenceResult__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_package__msg__InferenceResult * data = NULL;

  if (size) {
    data = (my_package__msg__InferenceResult *)allocator.zero_allocate(size, sizeof(my_package__msg__InferenceResult), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_package__msg__InferenceResult__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        my_package__msg__InferenceResult__fini(&data[i - 1]);
      }
...
my_package__msg__InferenceResult__Sequence__fini(my_package__msg__InferenceResult__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      my_package__msg__InferenceResult__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_package__msg__InferenceResult__Sequence * array = (my_package__msg__InferenceResult__Sequence *)allocator.allocate(sizeof(my_package__msg__InferenceResult__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_package__msg__InferenceResult__Sequence__init(array, size);
  if (!success) {
...
my_package__msg__InferenceResult__Sequence__destroy(my_package__msg__InferenceResult__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_package__msg__InferenceResult__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_package__msg__InferenceResult__Sequence__are_equal(const my_package__msg__InferenceResult__Sequence * lhs, const my_package__msg__InferenceResult__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_package__msg__InferenceResult__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_package__msg__InferenceResult__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_package__msg__InferenceResult);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_package__msg__InferenceResult * data =
      (my_package__msg__InferenceResult *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_package__msg__InferenceResult__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_package__msg__InferenceResult__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_package__msg__InferenceResult__copy(
